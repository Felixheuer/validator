...
const (
	tagIdentifier         = "json" //tagName idetify the struct tag for validator
	tagSeparator          = "|"    //tagSeparator use to separate tags in struct
	defaultFormSize int64 = 1024 * 1024 * 1
)

type (
	// MapData represents basic data structure for validator Rules and Messages
...
// ref: https://github.com/thedevsaddam/validator#example
